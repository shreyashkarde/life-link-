  ...
  useEffect(() => {
    const loadMapData = async () => {
      try {
        ...
        const ambRes = await fetch(`http://localhost:5000/api/ambulance/nearby?lat=${userLocation.lat}&lng=${userLocation.lng}&radiusKm=25`);
        ...
        const hospRes = await fetch(`http://localhost:5000/api/hospitals/nearby?lat=${userLocation.lat}&lng=${userLocation.lng}&radiusKm=25`);
